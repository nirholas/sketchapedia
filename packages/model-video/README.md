...
**Populated by prompt 18.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/18-*.md`](../../prompts/).
...
```ts
import { modelVideoPackageName } from '@sketchapedia/model-video';
```
