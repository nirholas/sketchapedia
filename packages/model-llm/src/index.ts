 ...
 *
 * Populated by prompt 16. This file is the scaffold stub produced by
 ...
 */
export const modelLlmDeps = [{ name: protocolPackageName satisfies ProtocolPackageName }] as const;

export const modelLlmPackageName = '@sketchapedia/model-llm' as const;

export type ModelLlmPackageName = typeof modelLlmPackageName;
 ...
 * cross-package smoke tests until prompt 16 lands.
 */
export function resolveModelLlmName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return modelLlmPackageName;
}
