/**
 * @sketchapedia/client-react
 *
 * React 19 bindings for @sketchapedia/client-core.
 *
 * Populated by prompt 10. This file is the scaffold stub produced by
 ...
 */
export const clientReactDeps = [
  { name: clientCorePackageName satisfies ClientCorePackageName },
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const clientReactPackageName = '@sketchapedia/client-react' as const;

export type ClientReactPackageName = typeof clientReactPackageName;
 ...
 * cross-package smoke tests until prompt 10 lands.
 */
export function resolveClientReactName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return clientReactPackageName;
}
