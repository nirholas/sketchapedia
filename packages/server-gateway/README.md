...
**Populated by prompt 14.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/14-*.md`](../../prompts/).
...
```ts
import { serverGatewayPackageName } from '@sketchapedia/server-gateway';
```
