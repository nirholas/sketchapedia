...
**Populated by prompt 17.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/17-*.md`](../../prompts/).
...
```ts
import { modelImagePackageName } from '@sketchapedia/model-image';
```
