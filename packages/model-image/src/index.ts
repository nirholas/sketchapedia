/**
 * @sketchapedia/model-image
 *
 * Image model runtime — FLUX.1-dev with IP-Adapter + ControlNet reference conditioning.
 *
 * Populated by prompt 17. This file is the scaffold stub produced by
 ...
 */
export const modelImageDeps = [
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const modelImagePackageName = '@sketchapedia/model-image' as const;

export type ModelImagePackageName = typeof modelImagePackageName;
 ...
 * cross-package smoke tests until prompt 17 lands.
 */
export function resolveModelImageName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return modelImagePackageName;
}
