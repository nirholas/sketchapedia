 ...
 *
 * Populated by prompt 15. This file is the scaffold stub produced by
 ...
 */
export const serverOrchestratorDeps = [
  { name: cacheKeysPackageName satisfies CacheKeysPackageName },
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const serverOrchestratorPackageName = '@sketchapedia/server-orchestrator' as const;

export type ServerOrchestratorPackageName = typeof serverOrchestratorPackageName;
 ...
 * cross-package smoke tests until prompt 15 lands.
 */
export function resolveServerOrchestratorName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return serverOrchestratorPackageName;
}
