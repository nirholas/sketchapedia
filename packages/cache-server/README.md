...
**Populated by prompt 20.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/20-*.md`](../../prompts/).
...
```ts
import { cacheServerPackageName } from '@sketchapedia/cache-server';
```
