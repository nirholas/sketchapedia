 ...
 *
 * Populated by prompt 23. This file is the scaffold stub produced by
 ...
 */
export const devtoolsDeps = [
  { name: clientCorePackageName satisfies ClientCorePackageName },
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const devtoolsPackageName = '@sketchapedia/devtools' as const;

export type DevtoolsPackageName = typeof devtoolsPackageName;
 ...
 * cross-package smoke tests until prompt 23 lands.
 */
export function resolveDevtoolsName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return devtoolsPackageName;
}
