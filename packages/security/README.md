...
**Populated by prompt 26.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/26-*.md`](../../prompts/).
...
```ts
import { securityPackageName } from '@sketchapedia/security';
```
