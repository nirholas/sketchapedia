/**
 * @sketchapedia/security
 *
 * Auth, CSP, prompt-injection defense, tenant isolation primitives.
 *
 * Populated by prompt 26. This file is the scaffold stub produced by
 ...
 */
export const securityDeps = [{ name: protocolPackageName satisfies ProtocolPackageName }] as const;

export const securityPackageName = '@sketchapedia/security' as const;

export type SecurityPackageName = typeof securityPackageName;
 ...
 * cross-package smoke tests until prompt 26 lands.
 */
export function resolveSecurityName(alias?: string | null): string {
