 ...
 *
 * Populated by prompt 19. This file is the scaffold stub produced by
 ...
 */
export const modelVisionDeps = [
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const modelVisionPackageName = '@sketchapedia/model-vision' as const;

export type ModelVisionPackageName = typeof modelVisionPackageName;
 ...
 * cross-package smoke tests until prompt 19 lands.
 */
export function resolveModelVisionName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return modelVisionPackageName;
}
