...
**Populated by prompt 21.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/21-*.md`](../../prompts/).
...
```ts
import { edgeWorkerPackageName } from '@sketchapedia/edge-worker';
```
