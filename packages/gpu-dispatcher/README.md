...
**Populated by prompt 22.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/22-*.md`](../../prompts/).
...
```ts
import { gpuDispatcherPackageName } from '@sketchapedia/gpu-dispatcher';
```
