/**
 * @sketchapedia/client-core
 *
 * Framework-agnostic Sketchapedia client SDK — canvas renderer, overlay, transport, cache.
 *
 * Populated by prompt 04-09, 11-13. This file is the scaffold stub produced by
 ...
 */
export const clientCoreDeps = [
  { name: cacheKeysPackageName satisfies CacheKeysPackageName },
  { name: protocolPackageName satisfies ProtocolPackageName },
] as const;

export const clientCorePackageName = '@sketchapedia/client-core' as const;

export type ClientCorePackageName = typeof clientCorePackageName;
 ...
 * cross-package smoke tests until prompt 04-09, 11-13 lands.
 */
export function resolveClientCoreName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return clientCorePackageName;
}
