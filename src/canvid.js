export default function canvid(params) {
    var defaultOptions = {
            width: 800,
            height: 450,
            selector: '.sketchapedia-wrapper'
        },
        firstPlay = true,
        control = {
            play: function() {
        ...
        loadImages(_opts.videos, function(err, images) {
            ...
            control.play = function(key, reverse, fps) {
                ...
                function drawFrame(f) {
                    ...
                    ctx.clearRect(0, 0, _opts.width, _opts.height);
    ...
    } else if (_opts.srcGif) {
        var fallbackImage = new Image();
        fallbackImage.src = _opts.srcGif;
    ...
    function initCanvas() {
        ...
        canvas.classList.add('sketchapedia');
    ...
    function hideChildren() {
        [].forEach.call(el.children, function(child) {
            if (!child.classList.contains('sketchapedia')) {
