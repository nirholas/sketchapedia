 ...
 *
 * Populated by prompt 31. This file is the scaffold stub produced by
 ...
 */
export const examplesTimesSquareDeps = [
...
export const examplesTimesSquarePackageName = '@sketchapedia/examples-times-square' as const;

export type ExamplesTimesSquarePackageName = typeof examplesTimesSquarePackageName;
 ...
 * cross-package smoke tests until prompt 31 lands.
 */
export function resolveExamplesTimesSquareName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return examplesTimesSquarePackageName;
}
