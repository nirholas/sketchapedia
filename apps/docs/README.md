...
**Populated by prompt 28.** This package is part of the Sketchapedia [monorepo](../../README.md); the canonical build spec lives at [`prompts/28-*.md`](../../prompts/).
...
```ts
import { docsPackageName } from '@sketchapedia/docs';
```
