 ...
 *
 * Populated by prompt 29. This file is the scaffold stub produced by
 ...
 */
export const examplesEiffelDeps = [
...
export const examplesEiffelPackageName = '@sketchapedia/examples-eiffel' as const;

export type ExamplesEiffelPackageName = typeof examplesEiffelPackageName;
 ...
 * cross-package smoke tests until prompt 29 lands.
 */
export function resolveExamplesEiffelName(alias?: string | null): string {
  if (alias !== null && alias !== undefined && alias.length > 0) {
    return alias;
  }
  return examplesEiffelPackageName;
}
