...
export default defineConfig({
  resolve: {
    alias: {
      '@sketchapedia/client-core': new URL('../packages/client-core/src/index.ts', import.meta.url)
        .pathname,
      '@sketchapedia/client-react': new URL(
        '../packages/client-react/src/index.ts',
        import.meta.url,
      ).pathname,
      '@sketchapedia/protocol': new URL('../packages/protocol/src/index.ts', import.meta.url)
        .pathname,
    },
  },
  test: {
